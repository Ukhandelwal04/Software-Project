...
import com.example.chatmessenger.R.id
...
//            })
        ...
        websi = view.findViewById(R.id.button3)
        adapter = UserAdapter()
        ...
        websi.setOnClickListener {
            view.findNavController().navigate(R.id.action_homeFragment_to_webActivity)
